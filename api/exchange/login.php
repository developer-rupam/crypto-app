...
if($_SERVER['REQUEST_METHOD'] == "POST" ){
			...
			if(
				...
				$sql = "SELECT user_id,first_name,last_name,email,created,status FROM user WHERE";
				$sql .=" email='".mysqli_real_escape_string($conn,$email)."' AND password='".mysqli_real_escape_string($conn,$password)."'";
